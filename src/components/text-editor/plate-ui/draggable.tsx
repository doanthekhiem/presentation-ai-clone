...
import { STRUCTURAL_TYPES } from "../utils/transforms";
...
export const Draggable = withRef<"div", PlateRenderElementProps>(({ ...props }, ref) => {
  ...
  return (
    ...
    >
      <Gutter>
        ...
        >
          <div
            className={cn("slate-blockToolbar", "pointer-events-auto mr-1 flex items-center", isInColumn && "mr-1.5")}
          >
      ...
      <div ref={previewRef as React.RefObject<HTMLDivElement>} className="slate-blockWrapper">
...
const DropLine = React.memo(
  React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => {
    const { dropLine } = useDropLine({ id: props.id });
